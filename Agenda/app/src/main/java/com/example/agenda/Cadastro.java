...
public class Cadastro extends AppCompatActivity {
      ...
      AdapterView.OnItemClickListener() {
        ...
        btSalvar.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                if (nome.isEmpty()) {
                    ...
                    Toast.makeText(Cadastro.this, "Cadastro salvo com " +
                            "sucesso", Toast.LENGTH_SHORT).show();
                    listarPessoas();
                    limpaCampos();
                    escondeTeclado();
                } else {
                    db.atualizarPessoa(new
                    Pessoa(Integer.parseInt(codigo), nome, telefone, email, endereco));
                            Toast.makeText(Cadastro.this, "Cadastro atualizado" +
        ...
        btExcluir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String codigo = cCodigo.getText().toString();
                if (codigo.isEmpty()) {
                    Toast.makeText(Cadastro.this, "Nenhuma pessoa está" +
                    ...
                    Toast.makeText(Cadastro.this, "Registro da pessoa" +
    ...
    public void listarPessoas() {
        ...
        adapter = new ArrayAdapter<String>(Cadastro.this,
